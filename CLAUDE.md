...
- HTML estático + JS vanilla. Sin framework, sin bundler, sin build del sitio. Chart.js 4.4 y three.js r128 por CDN, los dos con `defer`; el globo del hero (`assets/risk-sphere.js`) arranca tras el evento `load` y respeta `prefers-reduced-motion`.
